...
public class MaterialWrap
{
	...
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("SetFloatArray", new LuaCSFunction(MaterialWrap.SetFloatArray)),
			new LuaMethod("SetVectorArray", new LuaCSFunction(MaterialWrap.SetVectorArray)),
			new LuaMethod("SetColorArray", new LuaCSFunction(MaterialWrap.SetColorArray)),
			new LuaMethod("SetMatrixArray", new LuaCSFunction(MaterialWrap.SetMatrixArray)),
	...
	private static int SetFloatArray(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(float[])))
		{
			Material material = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int nameID = (int)LuaDLL.lua_tonumber(L, 2);
			float[] arrayNumber = LuaScriptMgr.GetArrayNumber<float>(L, 3);
			material.SetFloatArray(nameID, arrayNumber);
			return 0;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(float[])))
		{
			Material material2 = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string @string = LuaScriptMgr.GetString(L, 2);
			float[] arrayNumber2 = LuaScriptMgr.GetArrayNumber<float>(L, 3);
			material2.SetFloatArray(@string, arrayNumber2);
			return 0;
		}
	...
	private static int SetVectorArray(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(LuaTable[])))
		{
			Material material = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int nameID = (int)LuaDLL.lua_tonumber(L, 2);
			Vector4[] arrayObject = LuaScriptMgr.GetArrayObject<Vector4>(L, 3);
			material.SetVectorArray(nameID, arrayObject);
			return 0;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(LuaTable[])))
		{
			Material material2 = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string @string = LuaScriptMgr.GetString(L, 2);
			Vector4[] arrayObject2 = LuaScriptMgr.GetArrayObject<Vector4>(L, 3);
			material2.SetVectorArray(@string, arrayObject2);
			return 0;
		}
	...
	private static int SetColorArray(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(LuaTable[])))
		{
			Material material = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int nameID = (int)LuaDLL.lua_tonumber(L, 2);
			Color[] arrayObject = LuaScriptMgr.GetArrayObject<Color>(L, 3);
			material.SetColorArray(nameID, arrayObject);
			return 0;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(LuaTable[])))
		{
			Material material2 = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string @string = LuaScriptMgr.GetString(L, 2);
			Color[] arrayObject2 = LuaScriptMgr.GetArrayObject<Color>(L, 3);
			material2.SetColorArray(@string, arrayObject2);
			return 0;
		}
	...
	private static int SetMatrixArray(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(Matrix4x4[])))
		{
			Material material = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int nameID = (int)LuaDLL.lua_tonumber(L, 2);
			Matrix4x4[] arrayObject = LuaScriptMgr.GetArrayObject<Matrix4x4>(L, 3);
			material.SetMatrixArray(nameID, arrayObject);
			return 0;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(Matrix4x4[])))
		{
			Material material2 = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string @string = LuaScriptMgr.GetString(L, 2);
			Matrix4x4[] arrayObject2 = LuaScriptMgr.GetArrayObject<Matrix4x4>(L, 3);
			material2.SetMatrixArray(@string, arrayObject2);
			return 0;
		}
