...
public class CharacterControllerWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("enableOverlapRecovery", new LuaCSFunction(CharacterControllerWrap.get_enableOverlapRecovery), new LuaCSFunction(CharacterControllerWrap.set_enableOverlapRecovery))
		};
	...
	private static int get_enableOverlapRecovery(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, characterController.enableOverlapRecovery);
		return 1;
	}
	...
	private static int set_enableOverlapRecovery(IntPtr L)
	{
		...
		characterController.enableOverlapRecovery = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
