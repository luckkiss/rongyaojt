...
public class InputWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("touchPressureSupported", new LuaCSFunction(InputWrap.get_touchPressureSupported), null),
			new LuaField("stylusTouchSupported", new LuaCSFunction(InputWrap.get_stylusTouchSupported), null),
