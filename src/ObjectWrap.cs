...
public class ObjectWrap
{
	...
	private static int Instantiate(IntPtr L)
	{
		...
		if (num == 2)
		{
			...
			UnityEngine.Object obj2 = UnityEngine.Object.Instantiate(unityObject2, parent);
			LuaScriptMgr.Push(L, obj2);
			return 1;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(UnityEngine.Object), typeof(Transform), typeof(bool)))
		{
			UnityEngine.Object original = (UnityEngine.Object)LuaScriptMgr.GetLuaObject(L, 1);
			Transform parent2 = (Transform)LuaScriptMgr.GetLuaObject(L, 2);
			bool worldPositionStays = LuaDLL.lua_toboolean(L, 3);
			UnityEngine.Object obj3 = UnityEngine.Object.Instantiate(original, parent2, worldPositionStays);
			LuaScriptMgr.Push(L, obj3);
			return 1;
		}
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(UnityEngine.Object), typeof(LuaTable), typeof(LuaTable)))
		{
			UnityEngine.Object original2 = (UnityEngine.Object)LuaScriptMgr.GetLuaObject(L, 1);
			Vector3 vector = LuaScriptMgr.GetVector3(L, 2);
			Quaternion quaternion = LuaScriptMgr.GetQuaternion(L, 3);
			UnityEngine.Object obj4 = UnityEngine.Object.Instantiate(original2, vector, quaternion);
			LuaScriptMgr.Push(L, obj4);
			return 1;
		}
		if (num == 4)
		{
			UnityEngine.Object unityObject3 = LuaScriptMgr.GetUnityObject(L, 1, typeof(UnityEngine.Object));
			Vector3 vector2 = LuaScriptMgr.GetVector3(L, 2);
			Quaternion quaternion2 = LuaScriptMgr.GetQuaternion(L, 3);
			Transform parent3 = (Transform)LuaScriptMgr.GetUnityObject(L, 4, typeof(Transform));
			UnityEngine.Object obj5 = UnityEngine.Object.Instantiate(unityObject3, vector2, quaternion2, parent3);
