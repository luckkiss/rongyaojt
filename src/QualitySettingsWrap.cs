...
public class QualitySettingsWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("shadowResolution", new LuaCSFunction(QualitySettingsWrap.get_shadowResolution), new LuaCSFunction(QualitySettingsWrap.set_shadowResolution)),
	...
	{
		QualitySettings.shadowResolution = (ShadowResolution)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(ShadowResolution)));
		return 0;
	}
