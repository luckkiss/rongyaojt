...
public class SkinnedMeshRendererWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("skinnedMotionVectors", new LuaCSFunction(SkinnedMeshRendererWrap.get_skinnedMotionVectors), new LuaCSFunction(SkinnedMeshRendererWrap.set_skinnedMotionVectors)),
	...
	private static int get_skinnedMotionVectors(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, skinnedMeshRenderer.skinnedMotionVectors);
		return 1;
	}
	...
	private static int set_skinnedMotionVectors(IntPtr L)
	{
		...
		skinnedMeshRenderer.skinnedMotionVectors = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
