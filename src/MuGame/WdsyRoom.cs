...
namespace MuGame
{
	internal class WdsyRoom : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly WdsyRoom.<>c <>9 = new WdsyRoom.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			WdsyRoom.isOpen = true;
			this.data = MapModel.getInstance().getMapDta(108);
			bool flag = this.data == null;
			if (flag)
			{
				this.data = new MapData();
			}
			MapModel.getInstance().AddMapDta(108, this.data);
			MapData arg_79_0 = this.data;
			Action<int> arg_79_1;
			if ((arg_79_1 = WdsyRoom.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (WdsyRoom.<>c.<>9__5_0 = new Action<int>(WdsyRoom.<>c.<>9.<onStart>b__5_0));
			}
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			if ((arg_D3_2 = WdsyRoom.<>c.<>9__7_0) == null)
			{
				arg_D3_2 = (WdsyRoom.<>c.<>9__7_0 = new Action<object>(WdsyRoom.<>c.<>9.<onLevelFinish>b__7_0));
			}
