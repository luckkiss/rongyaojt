...
namespace MuGame
{
	internal class TlfbRoom111 : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly TlfbRoom111.<>c <>9 = new TlfbRoom111.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			TlfbRoom111.isOpen = true;
			this.data = MapModel.getInstance().getMapDta(111);
			bool flag = this.data == null;
			if (flag)
			{
				this.data = new MapData();
			}
			MapModel.getInstance().AddMapDta(111, this.data);
			MapData arg_79_0 = this.data;
			Action<int> arg_79_1;
			if ((arg_79_1 = TlfbRoom111.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (TlfbRoom111.<>c.<>9__5_0 = new Action<int>(TlfbRoom111.<>c.<>9.<onStart>b__5_0));
			}
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			if ((arg_D3_2 = TlfbRoom111.<>c.<>9__7_0) == null)
			{
				arg_D3_2 = (TlfbRoom111.<>c.<>9__7_0 = new Action<object>(TlfbRoom111.<>c.<>9.<onLevelFinish>b__7_0));
			}
