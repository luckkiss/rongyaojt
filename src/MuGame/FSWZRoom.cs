...
namespace MuGame
{
	internal class FSWZRoom : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly FSWZRoom.<>c <>9 = new FSWZRoom.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			Action<int> arg_79_1;
			if ((arg_79_1 = FSWZRoom.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (FSWZRoom.<>c.<>9__5_0 = new Action<int>(FSWZRoom.<>c.<>9.<onStart>b__5_0));
			}
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			if ((arg_F3_2 = FSWZRoom.<>c.<>9__7_0) == null)
			{
				arg_F3_2 = (FSWZRoom.<>c.<>9__7_0 = new Action<object>(FSWZRoom.<>c.<>9.<onLevelFinish>b__7_0));
			}
