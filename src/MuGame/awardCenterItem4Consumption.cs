...
namespace MuGame
{
	internal class awardCenterItem4Consumption : BaseAwardCenter
	{
		...
		{
			BaseProxy<welfareProxy>.getInstance().sendWelfare(welfareProxy.ActiveType.accumulateConsumption, this.m_iwd.id);
		}
	}
}
