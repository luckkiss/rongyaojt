...
namespace MuGame
{
	internal class a3_counterpart_exp : a3BaseActive
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly a3_counterpart_exp.<>c <>9 = new a3_counterpart_exp.<>c();

			public static Action<GameObject> <>9__11_0;

			public static Action<GameObject> <>9__11_1;

			public static Action<GameObject> <>9__11_2;

			public static Action<GameObject> <>9__11_3;

			internal void <init>b__11_0(GameObject go)
			{
				a3_counterpart_exp.open = true;
				Variant variant = new Variant();
				variant["npcid"] = 0;
				variant["ltpid"] = 101;
				variant["diff_lvl"] = 1;
				a3_counterpart_exp.diff = variant["diff_lvl"];
			...
			internal void <init>b__11_2(GameObject go)
			{
				a3_counterpart_exp.open = true;
				Variant variant = new Variant();
				variant["mapid"] = 3334;
			...
			internal void <init>b__11_3(GameObject go)
			{
				a3_counterpart_exp.open = true;
				Variant variant = new Variant();
				variant["mapid"] = 3334;
		...
		public override void init()
		{
			...
			if ((arg_B4_1 = a3_counterpart_exp.<>c.<>9__11_0) == null)
			{
				arg_B4_1 = (a3_counterpart_exp.<>c.<>9__11_0 = new Action<GameObject>(a3_counterpart_exp.<>c.<>9.<init>b__11_0));
			}
			arg_B4_0.onClick = arg_B4_1;
			BaseButton arg_DF_0 = this.enterbtn1;
			Action<GameObject> arg_DF_1;
			if ((arg_DF_1 = a3_counterpart_exp.<>c.<>9__11_1) == null)
			{
				arg_DF_1 = (a3_counterpart_exp.<>c.<>9__11_1 = new Action<GameObject>(a3_counterpart_exp.<>c.<>9.<init>b__11_1));
			}
			arg_DF_0.onClick = arg_DF_1;
			BaseButton arg_10A_0 = this.enterbtn2;
			Action<GameObject> arg_10A_1;
			if ((arg_10A_1 = a3_counterpart_exp.<>c.<>9__11_2) == null)
			{
				arg_10A_1 = (a3_counterpart_exp.<>c.<>9__11_2 = new Action<GameObject>(a3_counterpart_exp.<>c.<>9.<init>b__11_2));
			}
			arg_10A_0.onClick = arg_10A_1;
			BaseButton arg_135_0 = this.enterbtn3;
			Action<GameObject> arg_135_1;
			if ((arg_135_1 = a3_counterpart_exp.<>c.<>9__11_3) == null)
			{
				arg_135_1 = (a3_counterpart_exp.<>c.<>9__11_3 = new Action<GameObject>(a3_counterpart_exp.<>c.<>9.<init>b__11_3));
			}
