...
namespace MuGame
{
	internal class ExpRoom : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly ExpRoom.<>c <>9 = new ExpRoom.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			ExpRoom.isOpen = true;
			this.data = MapModel.getInstance().getMapDta(101);
			bool flag = this.data == null;
			if (flag)
			{
				this.data = new MapData();
			}
			MapModel.getInstance().AddMapDta(101, this.data);
			MapData arg_79_0 = this.data;
			Action<int> arg_79_1;
			if ((arg_79_1 = ExpRoom.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (ExpRoom.<>c.<>9__5_0 = new Action<int>(ExpRoom.<>c.<>9.<onStart>b__5_0));
			}
		...
		{
			bool flag = msgData.ContainsKey("bo");
			if (flag)
			{
				int infBo = msgData["bo"];
				bool flag2 = a3_insideui_fb.instance != null;
				if (flag2)
				{
					a3_insideui_fb.instance.SetInfBo(infBo);
				}
			}
			return true;
		}
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			if ((arg_F3_2 = ExpRoom.<>c.<>9__8_0) == null)
			{
				arg_F3_2 = (ExpRoom.<>c.<>9__8_0 = new Action<object>(ExpRoom.<>c.<>9.<onLevelFinish>b__8_0));
			}
