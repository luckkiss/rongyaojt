...
namespace MuGame
{
	internal class a3_counterpart_mate : a3BaseActive
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly a3_counterpart_mate.<>c <>9 = new a3_counterpart_mate.<>c();
		...
		public override void init()
		{
			...
			if ((arg_B4_1 = a3_counterpart_mate.<>c.<>9__10_0) == null)
			{
				arg_B4_1 = (a3_counterpart_mate.<>c.<>9__10_0 = new Action<GameObject>(a3_counterpart_mate.<>c.<>9.<init>b__10_0));
			}
			arg_B4_0.onClick = arg_B4_1;
			BaseButton arg_DF_0 = this.enterbtn1;
			Action<GameObject> arg_DF_1;
			if ((arg_DF_1 = a3_counterpart_mate.<>c.<>9__10_1) == null)
			{
				arg_DF_1 = (a3_counterpart_mate.<>c.<>9__10_1 = new Action<GameObject>(a3_counterpart_mate.<>c.<>9.<init>b__10_1));
			}
			arg_DF_0.onClick = arg_DF_1;
			BaseButton arg_10A_0 = this.enterbtn2;
			Action<GameObject> arg_10A_1;
			if ((arg_10A_1 = a3_counterpart_mate.<>c.<>9__10_2) == null)
			{
				arg_10A_1 = (a3_counterpart_mate.<>c.<>9__10_2 = new Action<GameObject>(a3_counterpart_mate.<>c.<>9.<init>b__10_2));
			}
			arg_10A_0.onClick = arg_10A_1;
			BaseButton arg_135_0 = this.enterbtn3;
			Action<GameObject> arg_135_1;
			if ((arg_135_1 = a3_counterpart_mate.<>c.<>9__10_3) == null)
			{
				arg_135_1 = (a3_counterpart_mate.<>c.<>9__10_3 = new Action<GameObject>(a3_counterpart_mate.<>c.<>9.<init>b__10_3));
			}
