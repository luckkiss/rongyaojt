...
namespace MuGame
{
	internal class TlfbRoom109 : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly TlfbRoom109.<>c <>9 = new TlfbRoom109.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			TlfbRoom109.isOpen = true;
			this.data = MapModel.getInstance().getMapDta(109);
			bool flag = this.data == null;
			if (flag)
			{
				this.data = new MapData();
			}
			MapModel.getInstance().AddMapDta(109, this.data);
			MapData arg_79_0 = this.data;
			Action<int> arg_79_1;
			if ((arg_79_1 = TlfbRoom109.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (TlfbRoom109.<>c.<>9__5_0 = new Action<int>(TlfbRoom109.<>c.<>9.<onStart>b__5_0));
			}
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			timersManager arg_D3_0 = new timersManager();
			int arg_D3_1 = 3;
			Action<object> arg_D3_2;
			if ((arg_D3_2 = TlfbRoom109.<>c.<>9__7_0) == null)
			{
				arg_D3_2 = (TlfbRoom109.<>c.<>9__7_0 = new Action<object>(TlfbRoom109.<>c.<>9.<onLevelFinish>b__7_0));
			}
			arg_D3_0.addTimer(arg_D3_1, arg_D3_2, 1, null);
