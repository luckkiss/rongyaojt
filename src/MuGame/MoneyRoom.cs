...
namespace MuGame
{
	internal class MoneyRoom : BaseRoomItem
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly MoneyRoom.<>c <>9 = new MoneyRoom.<>c();
		...
		public override void onStart(Variant svr)
		{
			...
			MoneyRoom.isOpen = true;
			this.data = MapModel.getInstance().getMapDta(102);
			bool flag = this.data == null;
			if (flag)
			{
				this.data = new MapData();
			}
			MapModel.getInstance().AddMapDta(102, this.data);
			MapData arg_79_0 = this.data;
			Action<int> arg_79_1;
			if ((arg_79_1 = MoneyRoom.<>c.<>9__5_0) == null)
			{
				arg_79_1 = (MoneyRoom.<>c.<>9__5_0 = new Action<int>(MoneyRoom.<>c.<>9.<onStart>b__5_0));
			}
			arg_79_0.OnKillNumChange = arg_79_1;
			this.startMoney = ModelBase<PlayerModel>.getInstance().money;
			MapModel.getInstance().curLevelId = 102u;
			...
			bool flag4 = a3_insideui_fb.instance != null;
			if (flag4)
			{
				int goldLeft = this.enterdata["energy"];
				a3_insideui_fb.instance.SetGoldLeft(goldLeft);
			}
		...
		public override bool onLevel_Status_Changes(Variant msgData)
		{
			...
			bool flag2 = msgData.ContainsKey("energy");
			if (flag2)
			{
				int goldLeft = msgData["energy"];
		...
		public override bool onLevelFinish(Variant msgData)
		{
			...
			if ((arg_F3_2 = MoneyRoom.<>c.<>9__8_0) == null)
			{
				arg_F3_2 = (MoneyRoom.<>c.<>9__8_0 = new Action<object>(MoneyRoom.<>c.<>9.<onLevelFinish>b__8_0));
			}
			...
			new timersManager().addTimer(delayTime, delegate(object o)
			{
				...
				int addmoney = a3_insideui_fb.instance.addmoney;
