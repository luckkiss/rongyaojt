...
public class DepthOfField34 : PostEffectsBase
{
	...
	[NonSerialized]
	public static Shader DOF_BLUR_SHADER;

	private Material dofBlurMaterial;

	[NonSerialized]
	public static Shader DOF_SHADER;
	...
	[NonSerialized]
	public static Shader BOKEN_SHADER;
	...
	{
		if (DepthOfField34.DOF_BLUR_SHADER == null || DepthOfField34.DOF_SHADER == null || DepthOfField34.BOKEN_SHADER == null)
		{
		...
		{
			this.dofBlurMaterial = this.CheckShaderAndCreateMaterial(DepthOfField34.DOF_BLUR_SHADER, this.dofBlurMaterial);
			this.dofMaterial = this.CheckShaderAndCreateMaterial(DepthOfField34.DOF_SHADER, this.dofMaterial);
			this.bokehSupport = DepthOfField34.BOKEN_SHADER.isSupported;
			if (this.bokeh && this.bokehSupport && DepthOfField34.BOKEN_SHADER)
			{
				this.bokehMaterial = this.CheckShaderAndCreateMaterial(DepthOfField34.BOKEN_SHADER, this.bokehMaterial);
			}
		}
	}
	...
	public override void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		else
		{
			...
			if (this.simpleTweakMode)
			{
				...
				if (arg_12C_0 = flag)
				{
					arg_12C_0 = (this.focalPoint > this.GetComponent<Camera>().nearClipPlane + Mathf.Epsilon);
				}
				flag = arg_12C_0;
			}
			else
			{
				...
				if (arg_1D0_0 = flag)
				{
					arg_1D0_0 = (this.focalPoint > this.GetComponent<Camera>().nearClipPlane + Mathf.Epsilon);
				}
				flag = arg_1D0_0;
			}
