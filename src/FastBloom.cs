...
public class FastBloom : PostEffectsBase
{
	...
	[NonSerialized]
	public static Shader FAST_BLOOMSHADER;
	...
	{
		bool arg_5A_0;
		if (FastBloom.FAST_BLOOMSHADER == null)
		{
		...
		else
		{
			...
			this.fastBloomMaterial = this.CheckShaderAndCreateMaterial(FastBloom.FAST_BLOOMSHADER, this.fastBloomMaterial);
			if (!this.isSupported)
			{
				this.ReportAutoDisable();
			}
			arg_5A_0 = this.isSupported;
		}
		return arg_5A_0;
	}
