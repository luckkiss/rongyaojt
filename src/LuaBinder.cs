...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		case "ButtonWrap":
			...
			break;
		case "Button_ButtonClickedEventWrap":
			Button_ButtonClickedEventWrap.Register(L);
			break;
		...
		case "TypeWrap":
			TypeWrap.Register(L);
			break;
		case "UnityEngine_Events_UnityEventBaseWrap":
			UnityEngine_Events_UnityEventBaseWrap.Register(L);
			break;
		case "UnityEngine_Events_UnityEventWrap":
