...
public class RenderTextureWrap
{
	...
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("GetNativeDepthBufferPtr", new LuaCSFunction(RenderTextureWrap.GetNativeDepthBufferPtr)),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("dimension", new LuaCSFunction(RenderTextureWrap.get_dimension), new LuaCSFunction(RenderTextureWrap.set_dimension)),
	...
	private static int get_dimension(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, renderTexture.dimension);
		return 1;
	}
	...
	private static int set_dimension(IntPtr L)
	{
		...
		renderTexture.dimension = (TextureDimension)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(TextureDimension)));
		return 0;
	}
	...
	private static int GetNativeDepthBufferPtr(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, nativeDepthBufferPtr);
		return 1;
	}
