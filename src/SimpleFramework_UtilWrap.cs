...
public class SimpleFramework_UtilWrap
{
	...
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("sizeFile", new LuaCSFunction(SimpleFramework_UtilWrap.sizeFile)),
			...
			new LuaMethod("GetRelativePath", new LuaCSFunction(SimpleFramework_UtilWrap.GetRelativePath)),
			new LuaMethod("isInPhone", new LuaCSFunction(SimpleFramework_UtilWrap.isInPhone)),
			...
			new LuaMethod("CheckRuntimeFile", new LuaCSFunction(SimpleFramework_UtilWrap.CheckRuntimeFile)),
			...
			new LuaMethod("del", new LuaCSFunction(SimpleFramework_UtilWrap.del)),
			new LuaMethod("DeleteFolder", new LuaCSFunction(SimpleFramework_UtilWrap.DeleteFolder)),
			new LuaMethod("MoveDirectory", new LuaCSFunction(SimpleFramework_UtilWrap.MoveDirectory)),
			new LuaMethod("CopyDirectory", new LuaCSFunction(SimpleFramework_UtilWrap.CopyDirectory)),
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int sizeFile(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string luaString = LuaScriptMgr.GetLuaString(L, 1);
		long d = Util.sizeFile(luaString);
		LuaScriptMgr.Push(L, d);
		return 1;
	}
	...
	private static int GetRelativePath(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, relativePath);
		return 1;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int isInPhone(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 0);
		bool b = Util.isInPhone();
		LuaScriptMgr.Push(L, b);
		return 1;
	}
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int del(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string luaString = LuaScriptMgr.GetLuaString(L, 1);
		Util.del(luaString);
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int DeleteFolder(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string luaString = LuaScriptMgr.GetLuaString(L, 1);
		Util.DeleteFolder(luaString);
		return 0;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int MoveDirectory(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		string luaString = LuaScriptMgr.GetLuaString(L, 1);
		string luaString2 = LuaScriptMgr.GetLuaString(L, 2);
		Util.MoveDirectory(luaString, luaString2);
		return 0;
	}

	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int CopyDirectory(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 4);
		string luaString = LuaScriptMgr.GetLuaString(L, 1);
		string luaString2 = LuaScriptMgr.GetLuaString(L, 2);
		string luaString3 = LuaScriptMgr.GetLuaString(L, 3);
		string luaString4 = LuaScriptMgr.GetLuaString(L, 4);
		Util.CopyDirectory(luaString, luaString2, luaString3, luaString4);
		return 0;
	}
}
