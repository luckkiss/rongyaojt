...
public class TextureWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("dimension", new LuaCSFunction(TextureWrap.get_dimension), new LuaCSFunction(TextureWrap.set_dimension)),
	...
	private static int get_dimension(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, texture.dimension);
		return 1;
	}
	...
	private static int set_dimension(IntPtr L)
	{
		...
		texture.dimension = (TextureDimension)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(TextureDimension)));
		return 0;
	}
