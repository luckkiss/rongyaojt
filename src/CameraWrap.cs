...
public class CameraWrap
{
	...
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("ResetCullingMatrix", new LuaCSFunction(CameraWrap.ResetCullingMatrix)),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("nonJitteredProjectionMatrix", new LuaCSFunction(CameraWrap.get_nonJitteredProjectionMatrix), new LuaCSFunction(CameraWrap.set_nonJitteredProjectionMatrix)),
			...
			new LuaField("stereoTargetEye", new LuaCSFunction(CameraWrap.get_stereoTargetEye), new LuaCSFunction(CameraWrap.set_stereoTargetEye)),
			...
			new LuaField("cullingMatrix", new LuaCSFunction(CameraWrap.get_cullingMatrix), new LuaCSFunction(CameraWrap.set_cullingMatrix)),
			...
			new LuaField("commandBufferCount", new LuaCSFunction(CameraWrap.get_commandBufferCount), null)
		};
	...
	private static int get_nonJitteredProjectionMatrix(IntPtr L)
	{
		...
		LuaScriptMgr.PushValue(L, camera.nonJitteredProjectionMatrix);
		return 1;
	}
	...
	private static int get_stereoTargetEye(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, camera.stereoTargetEye);
		return 1;
	}
	...
	private static int get_cullingMatrix(IntPtr L)
	{
		...
		LuaScriptMgr.PushValue(L, camera.cullingMatrix);
		return 1;
	}
	...
	private static int set_nonJitteredProjectionMatrix(IntPtr L)
	{
		...
		camera.nonJitteredProjectionMatrix = (Matrix4x4)LuaScriptMgr.GetNetObject(L, 3, typeof(Matrix4x4));
		return 0;
	}
	...
	private static int set_stereoTargetEye(IntPtr L)
	{
		...
		camera.stereoTargetEye = (StereoTargetEyeMask)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(StereoTargetEyeMask)));
		return 0;
	}
	...
	private static int set_cullingMatrix(IntPtr L)
	{
		...
		camera.cullingMatrix = (Matrix4x4)LuaScriptMgr.GetNetObject(L, 3, typeof(Matrix4x4));
		return 0;
	}
	...
	private static int SetStereoViewMatrices(IntPtr L)
	{
		...
		Camera camera = (Camera)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Camera");
		Matrix4x4 leftMatrix = (Matrix4x4)LuaScriptMgr.GetNetObject(L, 2, typeof(Matrix4x4));
		Matrix4x4 rightMatrix = (Matrix4x4)LuaScriptMgr.GetNetObject(L, 3, typeof(Matrix4x4));
