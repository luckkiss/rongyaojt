...
public class TransformWrap
{
	...
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("hierarchyCapacity", new LuaCSFunction(TransformWrap.get_hierarchyCapacity), new LuaCSFunction(TransformWrap.set_hierarchyCapacity)),
			new LuaField("hierarchyCount", new LuaCSFunction(TransformWrap.get_hierarchyCount), null)
		};
	...
	private static int get_hierarchyCapacity(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, transform.hierarchyCapacity);
		return 1;
	}
	...
	private static int get_hierarchyCount(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, transform.hierarchyCount);
		return 1;
	}
	...
	private static int set_hierarchyCapacity(IntPtr L)
	{
		...
		transform.hierarchyCapacity = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
